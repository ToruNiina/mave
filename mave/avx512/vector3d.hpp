#ifndef MAVE_AVX512F_VECTOR3_DOUBLE_HPP
#define MAVE_AVX512F_VECTOR3_DOUBLE_HPP
...
#define MAVE_VECTOR3_DOUBLE_IMPLEMENTATION "avx512f"
          ...
          std::tuple<double, double> v2) noexcept
{
    ...
    const __m512d rslt = _mm512_div_pd(v11, v22);
    return std::make_pair(matrix<double, 3, 1>(_mm512_castpd512_pd256(rslt)),
                          matrix<double, 3, 1>(_mm512_extractf64x4_pd(rslt, 1)));
}
template<>
    ...
    const matrix<double, 3, 1>& v3) noexcept
{
    ...
    _mm256_store_pd(pack, _mm256_sqrt_pd(_mm256_add_pd(_mm256_add_pd(
            _mm512_castpd512_pd256(abc12), _mm512_extractf64x4_pd(abc12, 1)
            ), _mm512_castpd512_pd256(abc3x))));
    return std::make_tuple(pack[0], pack[1], pack[2]);
}
           ...
           const matrix<double, 3, 1>& v3) noexcept
{
    ...
    const __m256d len = _mm256_sqrt_pd(_mm256_add_pd(_mm256_add_pd(
            _mm512_castpd512_pd256(abc12), _mm512_extractf64x4_pd(abc12, 1)
            ), _mm512_castpd512_pd256(abc3x)));
    ...
    ) noexcept
{
    ...
    const __m512d rslt = _mm512_max_pd(v11, v22);
    return std::make_pair(matrix<double, 3, 1>(_mm512_castpd512_pd256(rslt)),
                          matrix<double, 3, 1>(_mm512_extractf64x4_pd(rslt, 1)));
}
template<>
    ...
    ) noexcept
{
    ...
    const __m512d rslt = _mm512_min_pd(v11, v22);
    return std::make_pair(matrix<double, 3, 1>(_mm512_castpd512_pd256(rslt)),
                          matrix<double, 3, 1>(_mm512_extractf64x4_pd(rslt, 1)));
}
template<>
