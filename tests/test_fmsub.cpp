#define BOOST_TEST_MODULE test_fmsub
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fmsub_1arg, T, test_targets)
{
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fmsub_2arg, T, test_targets)
{
    std::mt19937 mt(123456789);
    const auto scalars  = mave::test::generate_random<typename T::value_type>(N, mt);
    const auto vectors1 = mave::test::generate_random<T>(N, mt);
    ...
    for(std::size_t i=0; i<N; i+=2)
    {
        ...
        const auto  v3  = mave::fmsub(std::make_tuple( s1,  s2),
                                             std::tie(v11, v12),
                                             std::tie(v21, v22));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fmsub_3arg, T, test_targets)
{
    std::mt19937 mt(123456789);
    const auto scalars  = mave::test::generate_random<typename T::value_type>(N, mt);
    const auto vectors1 = mave::test::generate_random<T>(N, mt);
    ...
    for(std::size_t i=0; i<N; i+=3)
    {
        ...
        const auto  v3  = mave::fmsub(std::make_tuple( s1,  s2,  s3),
                                             std::tie(v11, v12, v13),
                                             std::tie(v21, v22, v23));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fmsub_4arg, T, test_targets)
{
    std::mt19937 mt(123456789);
    const auto scalars  = mave::test::generate_random<typename T::value_type>(N, mt);
    const auto vectors1 = mave::test::generate_random<T>(N, mt);
    ...
    for(std::size_t i=0; i<N; i+=4)
    {
        ...
        const auto  v3  = mave::fmsub(std::make_tuple( s1,  s2,  s3,  s4),
